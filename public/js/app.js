...
var swup = new swup__WEBPACK_IMPORTED_MODULE_1___default.a(); // only this line when included with script tag
...
init();
swup.on('contentReplaced', init); //swup.on('willReplaceContent', unInit);
...
/***/ "./resources/js/components/Advencement.js":
/*!************************************************!*\
  !*** ./resources/js/components/Advencement.js ***!
  \************************************************/
...
function Advencement(nbArtiste) {
  ...
  artisteSelect(document.querySelector(".artistes .artiste:nth-of-type(".concat(nbArtiste, ")")));
  var artistes = document.querySelectorAll(".artistes .artiste");
  artistes.forEach(function (artiste) {
    artiste.addEventListener('click', function (e) {
...
function artisteSelect(artiste) {
  ...
  var w = artiste.className.substring(10, 11) - 1;
...
function classement(x, etat) {
  if ((x - 11) % ecart == 0) {
    ...
    if (etat == "on") {
      document.querySelector(".adv div.adv-nb p:nth-of-type(".concat(nb, ")")).classList.add('adv-nb-active');
    } else {
      document.querySelector(".adv div.adv-nb p:nth-of-type(".concat(nb, ")")).classList.remove('adv-nb-active');
    }
  }
}

function colorSpan(pas) {
  var _loop = function _loop(pasSelect) {
    setTimeout(function () {
      document.querySelector(".advancement span:nth-of-type(".concat(pasSelect, ")")).classList.add('adv-cliked');
      classement(pasSelect, 'on');
    }, (pasSelect - selected) * 5);
  };

  for (var pasSelect = selected; pasSelect < pas + 2; pasSelect++) {
    _loop(pasSelect);
  }

  var _loop2 = function _loop2(pasUnSelect) {
    setTimeout(function () {
      document.querySelector(".advancement span:nth-of-type(".concat(pasUnSelect, ")")).classList.remove('adv-cliked');
      classement(pasUnSelect, 'off');
    }, (selected - pasUnSelect) * 5);
  };

  for (var pasUnSelect = selected + 1; pasUnSelect > pas + 1; pasUnSelect--) {
    _loop2(pasUnSelect);
  }
...
/***/ "./resources/js/components/ChoosePage.js":
/*!***********************************************!*\
  !*** ./resources/js/components/ChoosePage.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ChoosePage; });
function ChoosePage() {
  var pages = document.querySelectorAll('.menu nav ul li a');

  if (document.querySelector('.anchoose') != null) {
    var button = document.querySelector('.anchoose');
...
/***/ "./resources/js/components/CreateSpanMusic.js":
/*!****************************************************!*\
  !*** ./resources/js/components/CreateSpanMusic.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CreateSpanMusic; });
var max = 300;
var ecart = 30;
function CreateSpanMusic() {
  for (var pas = 0; pas < max; pas++) {
    var sp = document.createElement("SPAN");
    var alea = Math.random() * 30 + 5;
...
/***/ "./resources/js/components/SelectNav.js":
/*!**********************************************!*\
  !*** ./resources/js/components/SelectNav.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SelectNav; });
function SelectNav() {
  var pages = document.querySelectorAll('.menu nav ul li a');
  pages.forEach(function (page) {
    page.addEventListener('click', function () {
      ...
      var place = (page.className.substring(4, 5) - 1) * 48;
      document.querySelector(".select-nav").style.transform = "translate(0,".concat(place, "px)");
      setTimeout(function () {
...
__webpack_require__(/*! C:\Users\ASUS\Desktop\laraveltest\blog\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\ASUS\Desktop\laraveltest\blog\resources\sass\app.scss */"./resources/sass/app.scss");
